...
Answer: Overall, the DE results obtained by Li et al. have lower p-values than those obtained in this analysis.
Possible reasons for the discrepancies:
The paper looks at DE genes for each time point, more like a simple effect, but in this analysis, we look at the overall effect across the entire time points.
